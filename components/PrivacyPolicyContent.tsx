...
export function PrivacyPolicyContent({ titleId = "priv-title" }: PrivacyPolicyContentProps) {
  return (
    <>
      <h2 id={titleId}>Privacy Policy</h2>
      <p className="since">Last updated: 10th October 2025</p>
      <p>
        Optimize Works Ltd. ("we," "our," or "us") is committed to protecting the
        privacy and security of your personal data.
      </p>
      <h3>1. Data Collection</h3>
      <ul>
        <li>
          <strong>Personal Data:</strong> Name, email, phone, company name, job
        ...
        <li>
          <strong>Cookies and Tracking Technologies:</strong> See the Cookies
          section below.
        </li>
      </ul>
      ...
      <h3>4. Cookies</h3>
      <p>
        We use Essential, Analytical, Functionality, and Marketing cookies. You
        may decline via browser settings.
      </p>
